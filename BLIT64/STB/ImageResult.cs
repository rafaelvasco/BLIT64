...
namespace STB
{
	internal class ImageResult
    {
		...
		internal static unsafe ImageResult FromResult(byte* result, int width, int height, ColorComponents comp, ColorComponents req_comp)
		{
			if (result == null)
			{
		...
		public static unsafe ImageResult FromMemory(byte[] bytes, ColorComponents requiredComponents = ColorComponents.Default)
		{
			byte* result = null;
